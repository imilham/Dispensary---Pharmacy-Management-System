...
{
	// $brnum=$_POST['brnum'];
	$pharmacyName=$_POST['dispensaryName'];
	$pharmacyLocation=$_POST['dispensaryLocation'];
	$pharmacyIncharge=$_POST['dispensaryIncharge'];
	$pharmacyContact=$_POST['dispensaryContact'];
	$pharmOpen=$_POST['openingTime'];
	$pharmClose=$_POST['closingTime'];
	
	//$dis_i;

	$query=mysqli_query($con,"insert into tbl_pharmacy(pharmacy_name, pharmacy_brNum, pharmacy_location, pharmacy_incharge, pharmacy_opening, pharmacy_closing, pharmacy_status,user_id, pharmacy_reg, pharmacy_tp, pharmacy_email) 
												values('$pharmacyName','$brNum','$pharmacyLocation','$pharmacyIncharge','$pharmOpen','$pharmClose','Pending','$user_id',current_date(), '$pharmacyContact', '$email')");
	if($query)
	{
...
<html lang="en">
	...
	<head>
		<title>Pharmacy Data Insert</title>
	...
	<!-- start: REGISTRATION -->
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2>D & P MS | Insert Pharmacy Data</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
				<div class="box-register">
					<form name="registration" id="registration"  method="post" onSubmit="return valid();">
						<fieldset>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="text" class="form-control" name="dispensaryLocation" id="dispensaryLocation"  placeholder="Pharmacy Location" required>
									<i class="fa fa-user"></i> </span>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="text" class="form-control" name="dispensaryIncharge" id="dispensaryIncharge"  placeholder="Pharmacy Incharge" required>
									<i class="fa fa-user"></i> </span>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="text"maxlength="10" class="form-control" name="dispensaryContact" id="dispensaryContact"  placeholder="Pharmacy Contact Number" required>
									<i class="fa fa-user"></i> </span>
							...
							<div class="form-group">
								<label for="">Pharmacy Opening Time:</label>
							...
							<div class="form-group">
								<label for="">Pharmacy Closing Time :</label>
