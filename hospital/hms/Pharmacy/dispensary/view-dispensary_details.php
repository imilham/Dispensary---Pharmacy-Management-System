...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Doctor | View Dispensary</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Doctor</span>
...
while ($row=mysqli_fetch_array($ret)) {
	...
	<tr>
		...
		<td><?php  echo $row['dispensary_contact'];?></td>
