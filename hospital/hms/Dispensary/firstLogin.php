...
if(isset($_POST['submit']))
{
    ...
    $ret=mysqli_query($con,"SELECT * FROM tbl_userlogins WHERE user_name='$uname' and user_password='$dpassword' and user_type = 'Doctor'");
			...
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend>
								Login In FIrst to Register your Details
							</legend>
							<p>
