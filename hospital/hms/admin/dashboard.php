								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Manage Dispensaries</h2>
...
<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Manage Pharmacies</h2>
...
{
?>
											Pending Pharmacies :<?php echo htmlentities($num_rows1);  } ?>		
												</a>
									...
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="links cl-effect-1">
												...
												<?php $sql= mysqli_query($con,"SELECT * FROM tbl_dispensary");
$num_rows2 = mysqli_num_rows($sql);
{
?>
											Pending Users :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
...
<?php $result = mysqli_query($con,"SELECT * FROM tbl_dispensary ");
$num_rows = mysqli_num_rows($result);
{
?>
